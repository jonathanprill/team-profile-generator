...
const addManager = employeeData => {
    ...
    return inquirer
        ...
        .then(projectData => {
            employeeData.members.push(projectData);
            //console.log(employeeData)

            if (projectData.confirmAddManager) {
...
const addIntern = employeeData => {
    ...
    return inquirer
        ...
        .then(projectData => {
            employeeData.members.push(projectData);
            //console.log(employeeData)
            if (projectData.confirmAddIntern) {
                return addEmployee(employeeData);
            } else {
                return employeeData;
            }
